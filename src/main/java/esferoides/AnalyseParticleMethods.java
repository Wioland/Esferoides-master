...
//		ParticleAnalyzer pa = new ParticleAnalyzer(ParticleAnalyzer.EXCLUDE_EDGE_PARTICLES, 0,rt, 0.01,
		...
		if (blackHole) {
			...
			if (exclude) {
				IJ.run(imp2, "Analyze Particles...",
						"size=20000-Infinity circularity=0.15-1.00 exclude add");
			} else {
...
//			} else {
//				IJ.run(imp2, "Analyze Particles...", "size=20000-Infinity circularity=0.00-1.00 show=Outlines add");
//			}
//		}
//		ImagePlus imp3 = IJ.getImage();
//		imp2.close();
